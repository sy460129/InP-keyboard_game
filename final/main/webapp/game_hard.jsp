    ...
    <body>
        <div class="nav">
            <div>
                ...
                <a href="list.jsp" title="�Խ���">Community</a>
                <a href="game.html" title="����">Game</a>
                <a href="ranking.html" title="��ŷ">Ranking</a>
            </div>
            <div>
               	<a href="index_ok.jsp"><%= u_id %>�� ȯ���մϴ�!</a>
                <a href="logout.jsp" style="font-size:20px" title="ȸ������">�α׾ƿ�</a>
                <a href="withdraw.jsp" style="font-size:20px" title="ȸ������">ȸ��Ż��</a>
            </div>
        </div>
        
        <div class="main">
            <span>
                <strong><span onclick="start()" style="color:white; cursor:pointer; font-size:21px">����</span></strong>
                <a href="index_ok.jsp" style="font-size:20px"><strong>����ȭ��</strong></a>
                <a href="game.html" style="font-size:20px"><strong>��������</strong></a><br><br>
            </span>
